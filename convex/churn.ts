...
// "ending" tampoco es baja: la persona sigue activa y pagada hasta el fin del período. Esa
// baja se registra cuando llega subscription_deactivated. Contarla acá la adelantaría al
